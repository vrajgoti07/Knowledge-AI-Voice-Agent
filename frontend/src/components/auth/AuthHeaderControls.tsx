...
// 2. Top-Right "Acoustic Core" truthful live status badge connected to /health.
        ...
        return (
          <>
            ...
            <span className="text-[11px] font-semibold text-slate-200 tracking-wider">
              Acoustic Core: <span className="text-accent-light font-bold">Checking...</span>
            </span>
          </>
        )
      case 'online':
      ...
      case 'degraded':
        return (
          <>
            ...
            <span className="text-[11px] font-semibold text-slate-200 tracking-wider">
              Acoustic Core: <span className="text-amber-400 font-bold">Degraded</span>
            </span>
          </>
        )
      case 'offline':
      default:
        return (
          <>
            ...
            <span className="text-[11px] font-semibold text-slate-200 tracking-wider">
              Acoustic Core: <span className="text-red-400 font-bold">Offline</span>
            </span>
          </>
        )
    }
