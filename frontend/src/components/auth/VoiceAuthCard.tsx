  ...
  return (
    <div className="relative w-full max-w-xl mx-auto z-20 flex items-center justify-center p-2">
      ...
      <motion.div
        ...
        className={cn(
          'w-full bg-[#050811]/75 backdrop-blur-2xl border border-slate-700/50 border-t-cyan-400/40 rounded-2xl shadow-[0_0_60px_rgba(0,136,255,0.22)] p-5 sm:p-7 relative overflow-hidden',
          'transition-all duration-300',
          isSuccess && 'border-cyan-400 shadow-[0_0_90px_rgba(0,242,254,0.8)]',
          className
        )}
      >
          ...
          {isSuccess && (
            ...
            >
              <div className="relative flex items-center justify-center">
                ...
                <CheckCircle2 className="w-7 h-7 text-cyan-400 absolute animate-pulse" />
              </div>

              <div className="space-y-1">
                <div className="text-xs sm:text-sm font-mono font-bold text-cyan-300 tracking-wider flex items-center justify-center gap-2">
